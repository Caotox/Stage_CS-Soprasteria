...
def xmlParserName(class_name):
    ...
    fichier_new2 = sys.argv[1]
    fichier_old2 = sys.argv[2]
    ...
    for m in range(max(len(elements_new2),len(elements_old2))):
        if len(elements_new2) == 0:
            if len(elements_old2) == 0 :
                ...
                print("Classe " + class_name + " vide dans nouveau fichier, " + str(elements_old2[m+ecart_index_old2]) + " dans ancien fichier")
        elif  len(elements_old2) == 0:
            if len(elements_new2) == 0 :
                print("Classe " + class_name + " vide")
            else :
                print("Classe " + class_name + " vide dans ancien fichier, " + str(elements_new2[m+ecart_index_new2]) + " dans nouveau fichier")
        elif len(elements_new2) - 1 <= m and len(elements_old2) > m:
            ecart_index_new2 -= 1
            #print("Fin nouveau fichier")
    ...
    for g in range(max(len(elements_new3),len(elements_old3))):
        if len(elements_new3) - 1 <= g and len(elements_old3) > g:
            ...
            if elements_new3[-1] == elements_old3[g + ecart_index_old3]:
                ...
                print("Nom : " + str(name) + " valeur " + str(elements_new3[-1]) + " dans nouveau fichier et " + str(elements_old3[g + ecart_index_old3]) + " dans ancien fichier")
            ...
            if elements_old3[-1] == elements_new3[g + ecart_index_new3]:
                ...
                print("Nom : " + str(name) +" Valeur " + str(elements_new3[g + ecart_index_new3]) + " dans nouveau fichier et " + str(elements_old3[-1]) + " dans ancien fichier")
            ...
            if elements_new3[-1] == elements_old3[-1]:
                ...
                print("Nom : " + str(name) +" Valeur " + str(elements_new3[-1]) + " dans nouveau fichier et " + str(elements_old3[-1]) + " dans ancien fichier")
            ...
            if elements_old3[g + ecart_index_old3] == elements_new3[g + 1 + ecart_index_new3]:
                ...
                print("Nom : " + str(name) +" Valeur " + str(elements_new3[g + ecart_index_new3]) + " dans nouveau fichier et " + str(elements_old3[g + ecart_index_old3]) + " dans ancien fichier")
                ecart_index_new3 -= 1
